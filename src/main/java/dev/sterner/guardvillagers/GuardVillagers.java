...
public class GuardVillagers implements ModInitializer {
    ...
    public static final Item MASON_GUARD_SPAWN_EGG = new SpawnEggItem(MASON_GUARD_VILLAGER, 5651507, 7434609, new Item.Settings());
        ...
        ServerTickEvents.END_SERVER_TICK.register(server -> {
            for (ServerWorld world : server.getWorlds()) {
                ...
                if (world.getTime() % 40L == 0L) {
                    ...
                    MasonBehavior.tryConvertMasonsWithTool(world);
                }
            }
        });
    }
