...
public final class VillagerProfessionBehaviors {
    ...
    public static void register() {
        ...
        VillagerProfessionBehaviorRegistry.registerBehavior(VillagerProfession.CARTOGRAPHER, new CartographerBehavior());
        ...
        VillagerProfessionBehaviorRegistry.registerBehavior(VillagerProfession.FISHERMAN, new FishermanBehavior());
