...
public class WeaponsmithBehavior implements VillagerProfessionBehavior {
    ...
    public void onChestPaired(ServerWorld world, VillagerEntity villager, BlockPos jobPos, BlockPos chestPos) {
        ...
        if (!ProfessionDefinitions.isExpectedJobBlock(VillagerProfession.WEAPONSMITH, world.getBlockState(jobPos))) {
            clearChestListener(villager);
            return;
        }
        ...
        LOGGER.info("Weaponsmith {} paired chest at {} for job site {}",
                villager.getUuidAsString(),
                chestPos.toShortString(),
                jobPos.toShortString());

        WeaponsmithDistributionGoal distributionGoal = DISTRIBUTION_GOALS.get(villager);
        if (distributionGoal == null) {
            distributionGoal = new WeaponsmithDistributionGoal(villager, jobPos, chestPos, null);
    ...
    public void onCraftingTablePaired(ServerWorld world, VillagerEntity villager, BlockPos jobPos, BlockPos chestPos, BlockPos craftingTablePos) {
        ...
        if (goal == null) {
            goal = new WeaponsmithCraftingGoal(villager, jobPos, chestPos, craftingTablePos);
        ...
        WeaponsmithDistributionGoal distributionGoal = DISTRIBUTION_GOALS.get(villager);
        if (distributionGoal == null) {
            distributionGoal = new WeaponsmithDistributionGoal(villager, jobPos, chestPos, craftingTablePos);
            DISTRIBUTION_GOALS.put(villager, distributionGoal);
