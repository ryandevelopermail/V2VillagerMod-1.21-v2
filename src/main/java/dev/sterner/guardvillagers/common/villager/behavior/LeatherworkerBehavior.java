...
public class LeatherworkerBehavior implements VillagerProfessionBehavior {
    ...
    public void onChestPaired(ServerWorld world, VillagerEntity villager, BlockPos jobPos, BlockPos chestPos) {
        ...
        if (!ProfessionDefinitions.isExpectedJobBlock(VillagerProfession.LEATHERWORKER, world.getBlockState(jobPos))) {
            clearChestListener(villager);
            return;
        }
    ...
    public void onCraftingTablePaired(ServerWorld world, VillagerEntity villager, BlockPos jobPos, BlockPos chestPos, BlockPos craftingTablePos) {
        ...
        if (goal == null) {
            goal = new LeatherworkerCraftingGoal(villager, jobPos, chestPos, craftingTablePos);
