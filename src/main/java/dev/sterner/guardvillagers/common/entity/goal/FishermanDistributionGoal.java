...
public class FishermanDistributionGoal extends AbstractInventoryDistributionGoal {
    ...
    public FishermanDistributionGoal(VillagerEntity villager, BlockPos jobPos, BlockPos chestPos, BlockPos craftingTablePos) {
    ...
    protected boolean matchesProfession(VillagerEntity villager) {
        return villager.getVillagerData().getProfession() == VillagerProfession.FISHERMAN;
    }
