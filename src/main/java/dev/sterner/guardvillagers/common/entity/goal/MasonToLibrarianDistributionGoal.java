...
public class MasonToLibrarianDistributionGoal extends AbstractInventoryDistributionGoal {
    ...
    public MasonToLibrarianDistributionGoal(VillagerEntity villager, BlockPos jobPos, BlockPos chestPos, BlockPos craftingTablePos) {
        super(villager, jobPos, chestPos, craftingTablePos);
    }

    @Override
    protected boolean isDistributableItem(ItemStack stack) {
        return !stack.isEmpty() && COLLECTED_MATERIALS.contains(stack.getItem());
    }
